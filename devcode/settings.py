"""
Django settings for devcode project.
...
SECRET_KEY = '#7eny19v$!h4)6qhe5r8!o_%#@&)sne!_g_ms%o47vr3&hxt8u'
...
ROOT_URLCONF = 'devcode.urls'

WSGI_APPLICATION = 'devcode.wsgi.application'
